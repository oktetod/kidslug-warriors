...
export class ScreenManager {
  ...
  constructor(scene: Scene) {
    ...
    // Normalize all pixel values to a 400px-wide virtual coordinate space.
    // Babylon scales everything automatically to fit any screen resolution.
    this.gui.idealWidth = 400;
  }
